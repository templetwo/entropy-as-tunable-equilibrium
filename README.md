...
The v3 manuscript is published on Zenodo: **DOI [10.5281/zenodo.21223845](https://doi.org/10.5281/zenodo.21223845)** (v3-1.0.0, July 6 2026, CC-BY-4.0). The v4 manuscript (the complete v4.0–v4.3 arc, source at [v4/paper/](v4/paper/)) is published as well: **DOI [10.5281/zenodo.21288848](https://doi.org/10.5281/zenodo.21288848)** (v4-1.0.0, July 10 2026, CC-BY-4.0; tag `v4.0.0`).
